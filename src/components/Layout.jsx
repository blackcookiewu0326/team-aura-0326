    ...
    return (
        <div className="app-container">
            ...
            <header className={`app-header ${isHistoryMode ? 'app-header-history' : 'app-header-default'}`}>
                ...
                <div className="app-header-inner">
                    <div className="flex items-center gap-2">
                        ...
                        {/* 賽季選擇器 - 套用 .season-select 並加入 rounded-full (圓角) 與 px-2 (內距) 與 border (邊框) */}
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={actions.refreshApp} className="icon-button relative">
            ...
            <main className="app-main">
                ...
                {/* 重新整理提示橫幅 */}
                {needRefresh && (
                    <div onClick={actions.refreshApp} className="bg-indigo-600 text-white p-3 rounded-lg shadow-lg flex items-center justify-between cursor-pointer animate-fadeIn mb-4 hover:bg-indigo-700 transition-colors">
